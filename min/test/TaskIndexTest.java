 ...
 * Date: Jan 21, 2011
 */
public class TaskIndexTest extends UnitTest {
    @Before
    ...
    public void testFilter_noTagInGroup() throws Exception {
        ...
        List<Task> matchingTasks = TaskIndex.filterTasks (null, null, new String[]{"1"}, null, null, null);
        ...
        matchingTasks = TaskIndex.filterTasks (null, null, new String[]{"2"}, null, null, null);
        ...
        assertTrue(matchingTasks.get(3).id == 3);
        assertTrue(matchingTasks.get(4).id == 1);
    }

    @Test
    public void testFilter_checkedTags() throws Exception {
        // find all tasks with tag1
        List<Task> matchingTasks = TaskIndex.filterTasks (new String[]{"1"}, null, null, null, null, null);

        assertEquals(3, matchingTasks.size());
        assertTrue(matchingTasks.get(0).id == 6);
        assertTrue(matchingTasks.get(1).id == 2);
        assertTrue(matchingTasks.get(2).id == 1);
    }

    @Test
    public void testFilter_checkedTags_twoInSameGroup() throws Exception {
        // find all tasks with tag1 OR tag2
        List<Task> matchingTasks = TaskIndex.filterTasks (new String[]{"1", "2"}, null, null, null, null, null);

        assertEquals(4, matchingTasks.size());
        assertTrue(matchingTasks.get(0).id == 6);
        assertTrue(matchingTasks.get(1).id == 5);
        assertTrue(matchingTasks.get(2).id == 2);
        assertTrue(matchingTasks.get(3).id == 1);
    }
    ...
    public void testFilter_checkedTags_twoInDifferentGroups() throws Exception {
        ...
        List<Task> matchingTasks = TaskIndex.filterTasks (new String[]{"1", "13"}, null, null, null, null, null);
    ...
    public void testFilter_checkedTags_twoInDifferentGroups_twoInSameGroup() throws Exception {
        // find all tasks with tag1 AND tag13 (since they are in different groups)
        List<Task> matchingTasks = TaskIndex.filterTasks (new String[]{"1", "2", "13"}, null, null, null, null, null);
    ...
    public void testFilter_searchText() throws Exception {
        ...
        List<Task> matchingTasks = TaskIndex.filterTasks (null, "lucene", null, null, null, null);
    ...
    public void testFilter_searchText_checkedTags_false() throws Exception {
        ...
        List<Task> matchingTasks = TaskIndex.filterTasks (new String[]{"1"}, "lucene", null, null, null, null);
    ...
    public void testFilter_searchText_checkedTags_true() throws Exception {
        // find all tasks with "lucene" in the content And with tag1
        List<Task> matchingTasks = TaskIndex.filterTasks (new String[]{"13"}, "lucene", null, null, null, null);
    ...
    public void testFilter_searchText_OR() throws Exception {
        ...
        List<Task> matchingTasks = TaskIndex.filterTasks (null, "lucene group", null, null, null, null);

        assertEquals(2, matchingTasks.size());
        assertTrue(matchingTasks.get(0).id == 5);
    ...
    public void testFilter_searchText_AND() throws Exception {
        ...
        List<Task> matchingTasks = TaskIndex.filterTasks (null, "lucene AND group", null, null, null, null);
    ...
    public void testFilter_raisedBy() throws Exception {
        ...
        List<Task> matchingTasks = TaskIndex.filterTasks (null, null, null, new String[]{"1"}, null, null);

        assertEquals(2, matchingTasks.size());
        assertTrue(matchingTasks.get(0).id == 2);
        assertTrue(matchingTasks.get(1).id == 1);
    }

    @Test
    public void testFilter_raisedBy_checkedTags() throws Exception {
        // find all tasks owned by member1 and has tag1
        List<Task> matchingTasks = TaskIndex.filterTasks (new String[]{"1"}, null, null, new String[]{"1"}, null, null);
        ...
        matchingTasks = TaskIndex.filterTasks (new String[]{"4"}, null, null, new String[]{"1"}, null, null);
    ...
    public void testFilter_allYouCanEat() throws Exception {
        ...
        List<Task> matchingTasks = TaskIndex.filterTasks (new String[]{"1"}, "lucene", new String[]{"1"}, new String[]{"2"}, null, null);
