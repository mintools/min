...
$.fn.dateRangePicker = function(options){
		...
		var presetMenu = {
				pastRange: '<div class="dateRange_contain dateRange_wide"><div class="dateRange"><ul class="dateRange_presets">'+
					'<li class="dateRange_last7"><a href="javascript://">Past Week</a></li>'+
		...
		var start_date = parentDiv.find('[name=start_date]');
		var end_date = parentDiv.find('[name=end_date]');
		
		start_date.calendar({dateRange: true}).focus().css({'position': 'absolute', 'left': '-999999px', 'top': '4.2em'});
		end_date.calendar({dateRange: true}).focus().css({'position': 'absolute', 'left': '-999999px', 'top': '4.2em'});
		...
		$(btns_prevnext).click(function(){
			if(start_date.val() == 'All Dates After' || start_date.val() == 'All Dates Before' || start_date.val() == 'All Dates'){
				return false;
			}
			...
			//date from value
			var val1 = returnDate(start_date.val());
			var val2 = returnDate(end_date.val());
		...
		var dates = {
			...
			start_date.val(dates.today());
			end_date.val(dates.today());
		...
		parentDiv.find('li').click(function(){	
			...
			if($(this).is('.dateRange_yesterday')) {
				$(this).smallMenu();
				start_date.val(dates.yesterday());
				end_date.val(dates.yesterday());

			}
			if($(this).is('.dateRange_tomorrow')) {
				$(this).smallMenu();
				start_date.val(dates.tomorrow());
				end_date.val(dates.tomorrow());

			}
			if($(this).is('.dateRange_beginningOfWeek')) {
				$(this).smallMenu();
				start_date.val(dates.startOfWeek());
				end_date.val('');
			}
			if($(this).is('.dateRange_endOfWeek')) {
				$(this).smallMenu();
				start_date.val(dates.endOfWeek());
				end_date.val('');
			}
			if($(this).is('.dateRange_beginningOfMonth')) {
				$(this).smallMenu();
				start_date.val(dates.endOfMonth());
				end_date.val('');
			}
			if($(this).is('.dateRange_endOfMonth')) {
				$(this).smallMenu();
				start_date.val(dates.startOfMonth());
				end_date.val('');
			}
			if($(this).is('.dateRange_last7')) {
				$(this).smallMenu();
				start_date.val(dates.weekAgo());
				end_date.val(dates.today());
			...
			if($(this).is('.dateRange_next7')) {
				$(this).smallMenu();
				start_date.val(dates.today());
				end_date.val(dates.nextWeek());

			}
			if($(this).is('.dateRange_last30')) {
				$(this).smallMenu();
				start_date.val(dates.monthAgo());
				end_date.val(dates.today());
			...
			if($(this).is('.dateRange_next30')) {
				$(this).smallMenu();
				start_date.val(dates.today());
				end_date.val(dates.nextMonth());

			}
			if($(this).is('.dateRange_lastYear')) {
				$(this).smallMenu();
				start_date.val(dates.yearAgo());
				end_date.val(dates.today());
			...
			if($(this).is('.dateRange_nextYear')) {
				$(this).smallMenu();
				start_date.val(dates.today());
				end_date.val(dates.nextYear());

			}
			if($(this).is('.dateRange_allDates')) {
				$(this).smallMenu();
				start_date.val(dates.minDate());
				end_date.val(dates.today());
				//console.log('all');
			}
			if($(this).is('.dateRange_yearToDate')) {
				$(this).smallMenu();
				start_date.val(dates.ytdStart());
				end_date.val(dates.today());
			}
